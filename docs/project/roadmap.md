...
- Один питомец и два пользователя максимум в первом серверном этапе.
...
4. Проверить conflict card и conflict resolver.
5. После smoke/E2E прохода итеративно усилить тесты conflict flow, тексты и background orchestration.
6. Следующим большим структурным этапом добавить `infra/` без переноса Android и без ручного переопределения API-контракта.
